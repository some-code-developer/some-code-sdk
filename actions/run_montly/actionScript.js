...
try {
  ...
  let data = {
    ...
    jan: actionParameters.jan,
    feb: actionParameters.feb,
    mar: actionParameters.mar,
    apr: actionParameters.apr,
    may: actionParameters.may,
    jun: actionParameters.jun,
    jul: actionParameters.jul,
    aug: actionParameters.aug,
    sep: actionParameters.sep,
    oct: actionParameters.oct,
    nov: actionParameters.nov,
    dec: actionParameters.dec,

    every: parseInt(actionParameters.everyMonth),
